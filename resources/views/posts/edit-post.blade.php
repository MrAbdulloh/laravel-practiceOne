                    ...
                    <div class="contact-form">
                        ...
                        <form action="{{route('posts.update',$post->id)}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-row">
                                <div class="col-md-6">
                                    <div class="control-group">
                                        <input type="text" class="form-control" name="title" value="{{$post->title}}" id="name"
                                               placeholder="Title"
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" class="form-control-file" name="photo" value="{{$post->photo}}" id="exampleFormControlFile1">
                            </div>

                            <div class="control-group">
                                <input type="text" class="form-control" name="short_content"value="{{$post->short_content}}" id="subject"
                            ...
                            <div class="control-group">
                                <textarea class="form-control" rows="6" name="contents" id="message"
                                          ...
                                          data-validation-required-message="Please enter Contents">{{$post->contents}}</textarea>
                                <p class="help-block text-danger"></p>
                            </div>
                            <div>
